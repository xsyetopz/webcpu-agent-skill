...
```bash
npm install @xsyetopz/easel@0.4.5
bun add @xsyetopz/easel@0.4.5
pnpm add @xsyetopz/easel@0.4.5
yarn add @xsyetopz/easel@0.4.5
```
...
deno add npm:@xsyetopz/easel@0.4.5
deno add jsr:@xsyetopz/easel@0.4.5
```
